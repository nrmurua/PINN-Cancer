...
if __name__ == "__main__":
    # Patrón de archivos para procesar
    file_pattern = "./data/*.npy"  # Cambia la ruta según tu estructura de directorios
    noise_levels = [0.003]  # Niveles de ruido que deseas procesar

    # Carpeta de salida principal
    output_dir = "./noisy_data"
